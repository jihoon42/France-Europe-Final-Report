...
**동봉한 데이터 한 벌로 본문의 모든 수치·그림이 재생성된다.**
...
**두 방식 모두 핵심 명제는 동일하게 성립한다**: 국가 間 수렴 · 국가 內 발산 · 2024년 within 비중이 과반으로 역전. 본문은 인구가중(사람 1단위)을 헤드라인으로, 동일가중(지역 1단위)을 robustness로 함께 싣는다.
